...
input_filename_2 = '/Volumes/GoogleDrive/My Drive/UNC Press-Longleaf/DataSets/DLCMA00P/Individual Contacts Using Gen Comp_Indiv Names.csv'
...
for row in input_rec:
    ...
    if output_record['D1CRTZ']:
        output_record['D1CRTZ'] =  datetime.datetime.strptime(output_record['D1CRTZ'], "%d-%b-%y").strftime("%Y-%m-%d")
    if output_record['D1CHGZ']:
        output_record['D1CHGZ'] =  datetime.datetime.strptime(output_record['D1CHGZ'], "%d-%b-%y").strftime("%Y-%m-%d")
